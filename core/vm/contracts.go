...
func RunPrecompiledContract(p PrecompiledContract, caller common.Address, input []byte, suppliedGas uint64, logger *tracing.Hooks) (ret []byte, remainingGas uint64, err error) {
...
func (c *ecrecover) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *sha256hash) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *ripemd160hash) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *dataCopy) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bigModExp) Run(_ common.Address, input []byte) ([]byte, error) {
	var (
...
func (c *bn256AddIstanbul) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bn256AddByzantium) Run(_ common.Address, input []byte) ([]byte, error) {
	return runBn256Add(input)
}
...
func (c *bn256ScalarMulIstanbul) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bn256ScalarMulByzantium) Run(_ common.Address, input []byte) ([]byte, error) {
	return runBn256ScalarMul(input)
}
...
func (c *bn256PairingIstanbul) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bn256PairingByzantium) Run(_ common.Address, input []byte) ([]byte, error) {
	return runBn256Pairing(input)
}
...
func (c *blake2F) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G1Add) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G1MultiExp) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G2Add) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381G2MultiExp) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381Pairing) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381MapG1) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (c *bls12381MapG2) Run(_ common.Address, input []byte) ([]byte, error) {
...
func (b *kzgPointEvaluation) Run(_ common.Address, input []byte) ([]byte, error) {
